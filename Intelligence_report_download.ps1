...
# .\Intelligence_report_download.ps1 -Region "in1" -ReportId "bfbbed72-e2ec-45b5-bfd6-8b9d8b9599f5" -ClientId "report_api@c9ad4754-f40f-4997-8921-43d108fbf6d7.workspaceone.com" -ClientSecret "48788C2F05834754616379DA4E45DBF5B37F336C55BD2DF653CB4C1774B84ABD" -OutFile "DeviceInventory_$(Get-Date -Format "yyyyMMddHHmmss").csv"


#Configuration

    $Region = "in1"
    $ReportId = "bfbbed72-e2ec-45b5-bfd6-8b9d8b9599f5"
    $ClientId = "report_api@c9ad4754-f40f-4997-8921-43d108fbf6d7.workspaceone.com"
    $ClientSecret = "48788C2F05834754616379DA4E45DBF5B37F336C55BD2DF653CB4C1774B84ABD"
    $OutFile = "DeviceInventory_$(Get-Date -Format "yyyyMMddHHmmss").csv"
...
function Main() {
    $BaseApiUrl = "https://api.in1.data.workspaceone.com/v2/reports/"
    $BaseAuthUrl = "https://auth.in1.data.workspaceone.com/oauth/token"
